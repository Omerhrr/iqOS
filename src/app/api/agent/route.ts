...
const TOOLS: ToolSpec[] = [
  ...
  },
  {
    ...
    args: '{"name": "EUR compound", "watchlist": ["EURUSD"], "strategyId": "rsi-reversion", "tf": "1m", "stakePlan": {"kind": "compound", "base": 1, "maxStake": 50, "payoutCap": 70, "stopOnLoss": true}, "minScore": 60, "maxOpen": 1, "enabled": true}',
    run: (a) =>
      corePost('/bot_save', {
        ...a,
  ...
  {
    name: 'bot_restart',
    description: 'Restart a COMPOUND bot\'s cycle (use after a stop-on-loss halt - the bot stands down with "cycle ended" until you call this). Clears the halt and re-seeds the pot to base so the next trade bets the seed stake again. Only applies to compound stake plans; ask the user before restarting.',
    args: '{"id": "bot-abc123"}',
